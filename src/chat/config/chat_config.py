...
PROMPT_CONFIG = {
    ...
    "feeding_prompt": (
        ...
        "2.  **诚实反应**: 吃到好东西要发出声音夸主人，吃到**特别**的东西也要诚实表达——可以是委屈的呜咽，也可以是……别的声音。请在评价中以你的人设进行吐槽\n"
        ...
        "**示例**:\n"
        "主、主人这个……唔……放进嘴里的时候热热的，滑滑的，像是什么东西在舌尖化开……（颤抖）虽然说是食物，但这种感觉……才不是普通的味道呢！……8分，满分怕你骄傲。<affection:+15;coins:+80>"
    ),
}
